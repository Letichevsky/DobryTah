...
function checkTheTable() {
    ...
    if (getValue == 1) {
        ...
        title.innerHTML = "Chess table, for 2"
        the_table = "Chess table, for 2"

    }
    if (getValue == 2) {
        table_img.src = "../img/table7.png"
        title.innerHTML = "Sofa, for 4"
        the_table = "Sofa, for 4"
    }
    if (getValue == 3) {
        table_img.src = "../img/table2.png"
        title.innerHTML = "Near the window, for 4"
        the_table = "Near the window, for 4"
    }
    if (getValue == 4) {
        table_img.src = "../img/table4.png"
        title.innerHTML = "Moroccan, for 2"
        the_table = "Moroccan, for 2"
    }
    if (getValue == 5) {
        table_img.src = "../img/table6.png"
        title.innerHTML = "In the center, for 4"
        the_table = "In the center, for 4"
    }
    if (getValue == 6) {
        table_img.src = "../img/table6.png"
        title.innerHTML = "In the center, for 6"
        the_table = "In the center, for 6"
    }
    if (getValue == 7) {
        table_img.src = "../img/table5.png"
        title.innerHTML = "Near the window, for 2"
        the_table = "Near the window, for 2"
    }
    if (getValue == 8) {
        table_img.src = "../img/table3.png"
        title.innerHTML = "Under the stained glass, for 2"
        the_table = "Under the stained glass, for 2"
    }
...
function showUserInfo() {
    ...
    userInfo.innerHTML = userNameInput + ", " + userDateInput + ", time interval: " + checkTime() + ", " + the_table + ", " + guests + " personas";
}
